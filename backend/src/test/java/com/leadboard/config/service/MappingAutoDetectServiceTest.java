...
class MappingAutoDetectServiceTest {
    ...
    void setUp() {
        ...
        // JiraConfigResolver returns null project key by default (no env configured)
    ...
    // ==================== computeWeightFromLevel ====================

    @Nested
    @DisplayName("computeWeightFromLevel()")
    class ComputeWeightFromLevelTests {
