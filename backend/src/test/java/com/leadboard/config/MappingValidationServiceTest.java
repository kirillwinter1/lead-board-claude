...
class MappingValidationServiceTest {
    ...
    void validConfig_returnsNoErrors() {
        ...
        List<StatusMappingDto> statuses = List.of(
                new StatusMappingDto(1L, "Done", BoardCategory.EPIC, StatusCategory.DONE, null, 10, 100, null, null),
                new StatusMappingDto(2L, "Done", BoardCategory.STORY, StatusCategory.DONE, null, 10, 100, null, null),
                new StatusMappingDto(3L, "Done", BoardCategory.SUBTASK, StatusCategory.DONE, null, 10, 100, null, null)
        );
    ...
    void noDoneStatus_returnsWarning() {
        ...
        List<StatusMappingDto> statuses = List.of(
                new StatusMappingDto(1L, "New", BoardCategory.EPIC, StatusCategory.NEW, null, 1, 0, null, null)
        );
