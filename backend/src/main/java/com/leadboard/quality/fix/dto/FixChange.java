...
public record FixChange(
    ...
    public static FixChange jira(String issueKey, String summary, String field, String from, String to) {
        return new FixChange(issueKey, summary, field, from, to, false);
    }

    public static FixChange local(String issueKey, String summary, String field, String from, String to) {
        return new FixChange(issueKey, summary, field, from, to, true);
    }
}
