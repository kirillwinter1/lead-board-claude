...
public class MemberAnalyticsService {
     ...
     */
    public String[] resolveEpicInfo(JiraIssueEntity subtask, Map<String, JiraIssueEntity> cache) {
        String epicKey = null;
    ...
    public List<WeeklyTrend> buildWeeklyTrend(List<JiraIssueEntity> completedIssues, LocalDate endDate) {
    ...
    public MemberSummary buildSummary(List<JiraIssueEntity> completedIssues, BigDecimal hoursPerDay,
        ...
        BigDecimal capacityH = hoursPerDay.multiply(new BigDecimal(workdays));
    ...
    public BigDecimal calculateDsr(JiraIssueEntity issue) {
    ...
    public BigDecimal secondsToHours(Long seconds) {
