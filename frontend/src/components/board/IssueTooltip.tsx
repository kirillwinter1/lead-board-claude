...
import { TEXT_SECONDARY, TEXT_SUBTLE } from '../../constants/colors'
    ...
    <HoverInfoCard<IssueDetail>
      ...
      render={(d) => (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          ...
          {d.description ? (
            <div style={{ color: TEXT_SECONDARY, whiteSpace: 'pre-wrap', maxHeight: 260, overflow: 'hidden', lineHeight: 1.4 }}>
              {d.description}
            </div>
          ) : (
