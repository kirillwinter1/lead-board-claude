...
Начиная с [F84](F84_DQ_AUTOFIX.md) 19 из 38 правил можно исправить прямо со страницы кнопкой **Fix** (ADMIN/PROJECT_MANAGER/TEAM_LEAD): превью изменений, ввод недостающих данных, красное предупреждение для массовых/рискованных фиксов. Подробности — в спецификации F84.
