# F89: Log time — списание времени со страницы My Work

**Версия:** 0.89.0
**Статус:** В разработке
**Дата спеки:** 2026-07-08
**Базируется на:** F88 (My Work), ветка feat/f89-log-time поверх feat/f88-my-work
...
- Ручное управление remaining estimate.
