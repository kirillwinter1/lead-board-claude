...
3. **Минимальное стабильное состояние**
...
4. Указаны выполненные команды и их результат
5. Конфигурируемо (никаких хардкодов статусов/полей)
6. Миграции совместимы назад (или указана записка о миграции)
