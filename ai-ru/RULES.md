...
### Флаги (Flagged)
- Flagged → работа НЕ ведётся, понижаем приоритет, не включаем в планирование
- Epic: штраф AutoScore -100 (опускается ниже активных)
- Story: штраф AutoScore -200 (более жёсткий, т.к. story — единица планирования)
