...
- [ ] Перерасчёт Expected Done с учётом очереди

**Frontend:**
- [ ] Отображение текущего WIP в Summary: "3/6 WIP"
- [ ] Индикатор очереди для эпиков за пределами WIP

**Тесты:**
- [ ] Расчёт дат с WIP = 3 и 5 эпиками
- [ ] Эпик за пределами WIP начинается после завершения предыдущего
...
**Frontend:**
- [ ] Подсветка превышения WIP (жёлтый/красный)
- [ ] Рекомендации по оптимизации WIP
- [ ] График утилизации WIP во времени
