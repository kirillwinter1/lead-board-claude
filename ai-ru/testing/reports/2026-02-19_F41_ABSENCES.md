...
| BUG-25 | Несогласованность формата `createdAt` между POST (offset +03:00) и GET (UTC Z). Может вызвать проблемы при сравнении дат на фронте. | `TeamController.java` | ✅ FIXED (spring.jackson.time-zone: UTC) |
