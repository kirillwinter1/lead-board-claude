...
|------|----------|--------|
| 1 | Базовый WIP (командный лимит) | ⏳ |
| 2 | Роль-специфичные лимиты (SA/DEV/QA) | ⏳ |
| 3 | Подсветка и аналитика | ⏳ |

**Ключевые изменения:**
- Эпики за пределами WIP лимита начинаются когда освобождается слот
- Capacity концентрируется на активных эпиках (не размазывается на все)
- Более реалистичные прогнозы Expected Done
