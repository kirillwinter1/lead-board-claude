...
| F13. Автопланирование (MVP) | 🚧 В работе | - |
...
- AutoScore — автоматический расчёт приоритета эпиков
- Расчёт Expected Done с учётом capacity команды
- Колонка Expected Done в Board (дата + уверенность + дельта от Due date)
- Производственный календарь РФ
- Коэффициенты грейдов (Senior/Middle/Junior)
- Коэффициент рисков
- Последовательность ролей: SA → DEV → QA
...
**Зависимости:** F3, F5, F10, F11

**Критерии готовности MVP:**
- [ ] Производственный календарь РФ работает
- [ ] Конфигурация планирования в настройках команды
- [ ] AutoScore рассчитывается для эпиков
- [ ] Expected Done отображается в Board
- [ ] Прогноз учитывает capacity и последовательность ролей
- [ ] Ручное изменение приоритета работает
